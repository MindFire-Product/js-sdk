 ...
 *
 * // 2. Load the script
 * <script src="https://mf-cdn.web.app/voice-chat-component-v090.js" type="module"></script>
 *
...
class VoiceChatComponent extends HTMLElement {
  ...
  async getEphemeralKey() {
    try {
      ...
      const url = `${this.apiBaseUrl}/${this.apiVersion}/llms/token/${this.accountId}/${this.agentId}/${this.agentConfig.voice}`;
